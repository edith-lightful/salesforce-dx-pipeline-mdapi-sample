...
DEV_HUB_USERNAME="desynit-hub"
DEV_USERNAME="testdeploy"
STAGING_USERNAME="testdeploy"
PROD_USERNAME="testdeploy"

# Repository with your code
GITHUB_REPO="edith-lightful/salesforce-dx-pipeline-mdapi-sample"
